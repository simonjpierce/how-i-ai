...
- **Next:** the side-by-side verdicts on the two possible returns, then a naming pass for the 23 candidates with the team, then approval, then the historical clean-up.
