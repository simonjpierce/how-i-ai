...
Read `~/.claude/projects/<vault-key>/config.json` to find the vault path and the logs folder. Friction Log is at `<vault>/<logs_relative>/Friction Log.md` (default `<vault>/SYSTEM/Friction Log.md`).
