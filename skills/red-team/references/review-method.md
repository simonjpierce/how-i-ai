...
4. **Accuracy:** Are there factual claims that seem wrong, unsupported, or overstated? Cross-check against the context documents where possible. Flag anything that should be verified.
