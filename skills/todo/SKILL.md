...
Search the vault for the most relevant file(s) using Glob/Grep. Prefer files in the user's domain folders (whatever they set up during `/onboard`) and `<vault>/SYSTEM/Processes/` for process docs.
