...
- **A budget** — a limit on how many self-maintenance jobs can wait in the overnight queue at once, most useful first, so the system's work on itself never crowds out your real work.
