...
The morning plan also looks ahead at the calendar. When a meeting (not a flight or a placeholder hold) is coming up today or tomorrow and there's no brief for it yet, it says so and offers to build one: who's attending, what your notes and recent email say about them, what you promised last time, and a few points to raise. The maintainer first had a brief built automatically before every meeting, and dropped it. Offering one in the morning plan, so he chooses when it's worth having, is the version that stuck.
