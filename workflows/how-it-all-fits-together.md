...
**Early, before I'm even at the desk.** Overnight, the system has already done a full shift. A handful of scheduled jobs run while I sleep: new material that came in during the day (saved articles, papers, voice notes) gets pulled into the vault and filed; a self-improvement pass reviews yesterday's system errors and folds in small fixes; backups and health checks run. By the time I'm awake, the overnight housekeeping is done — and the day's plan has already been drafted from my calendar, tasks, email and each specialist's notes, and checked by a second model.

**My morning walk.** I talk to the system from my phone. It reads me the day's priorities, the emails that need my call, and the questions the specialist agents couldn't answer from their notes. I answer out loud — stream of consciousness, no structure; it's basically verbal journalling to help cage my monkey brain — and each answer sets work going in the background while I keep walking: a draft started, a question researched, a decision recorded ([the interview loop](./the-interview-loop.md)). Anything else I say gets [transcribed](./transcription.md) and filed: tasks to my to-do list, thought bubbles to my idea file for the AI to think about and make a plan for. I didn't have to organise any of this; I just thought out loud like a crazy person. A lot like a crazy person, in fact.

**The AI coaches my day.** When I'm at my desk, I open a Claude Code session and run /today. The plan it coaches me through comes from the **agent fleet** — a set of domain specialists, one each for my science, fundraising, external communications, executive oversight of our non-profit, photography plans and admin. Each agent reviews its own folder of notes in the vault and surfaces what it thinks needs my attention; the chief of staff agent collates all those jobs, weighs them against one another, folds in what I said on the walk, and hands me the **single most important first task** — not a wall of twenty bullet points, one thing, typically with the recommended action already worked out or a draft already created for me. The morning belongs to the non-profit's work, so it draws on those specialists.
...
**Afternoon.** After lunch a second coach takes over, for the work the main job would otherwise crowd out — photography, my websites, life admin — drawing on the specialists for those areas. It finishes by counting down the remaining email replies: the important ones were already sorted into the morning, and the rest get cleared here, one at a time.
...
- a **maintenance layer** — backups, health checks, and the self-improvement loop — that keeps the system in working order without your attention.
